export default function cloud() {
  ...
  document.getElementsByClassName("scroll__layer_back")[0].style.backgroundImage= "none";
  document.getElementsByClassName("scroll__layer_back")[0].innerHTML = svgBack
  document.getElementsByClassName("scroll__layer_middle")[0].style.backgroundImage = "none"
  document.getElementsByClassName("scroll__layer_middle")[0].innerHTML = svgMid
  document.getElementsByClassName("scroll__layer_front")[0].style.backgroundImage = 'none'; 
  document.getElementsByClassName("scroll__layer_front-svg")[0].innerHTML = svgFront
